...
export const ALLOWED_TRANSITIONS = {
    ...
    IN_ANALYSIS: ["PRICING", "REJECTED", "CANCELED"],
    PRICING: ["WAITING_APPROVAL", "CANCELED"],
    WAITING_APPROVAL: ["APPROVED", "REJECTED", "NEGOTIATING", "ABANDONED", "CANCELED"], // Abandon after 90d
    NEGOTIATING: ["APPROVED", "REJECTED", "CANCELED"],
    APPROVED: ["IN_PROGRESS", "CANCELED"],
    REJECTED: ["WAITING_PICKUP", "SCRAPPED", "CANCELED"], // Flow: Rejected -> Waiting Pick or Scrap
    ...
    INVOICED: ["WAITING_COLLECTION", "OPEN"],
